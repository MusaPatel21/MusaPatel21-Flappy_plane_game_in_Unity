...
{
    const string privateCode = "VFjlYtZ9BUStVL3ajvPTHggwZwub9jhUCD-qGgTy2f9w";  //Key to Upload New Info
    const string publicCode = "63d6507b8f40bb08f4a56c6c";   //Key to download
